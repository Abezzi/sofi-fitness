...
const Countdown = ({ time, title, next }: CountdownPropsType) => {
  ...
  let player5 = useAudioPlayer(
    require("../../assets/audio/countdown/esMX/male/5.mp3"),
  );
  let player4 = useAudioPlayer(
    require("../../assets/audio/countdown/esMX/male/4.mp3"),
  );
  let player3 = useAudioPlayer(
    require("../../assets/audio/countdown/esMX/male/3.mp3"),
  );
  let player2 = useAudioPlayer(
    require("../../assets/audio/countdown/esMX/male/2.mp3"),
  );
  ...
  return (
    <View className="justify-center items-center">
      <Card className="w-full max-w-sm p-6 rounder-2xl">
        <CardHeader>
